...
Received: from mail.linuxfoundation.org (mail.linuxfoundation.org [140.211.169.12])
	by mail.lfdr.de (Postfix) with ESMTPS id 81F62AE7B9
	for <lists.virtualization@lfdr.de>; Tue, 10 Sep 2019 12:15:50 +0200 (CEST)
Received: from mail.linux-foundation.org (localhost [127.0.0.1])
	by mail.linuxfoundation.org (Postfix) with ESMTP id A9828ED3;
	Tue, 10 Sep 2019 10:15:42 +0000 (UTC)
X-Original-To: virtualization@lists.linux-foundation.org
Delivered-To: virtualization@mail.linuxfoundation.org
Received: from smtp1.linuxfoundation.org (smtp1.linux-foundation.org
	[172.17.192.35])
	by mail.linuxfoundation.org (Postfix) with ESMTPS id E6DE3EC5
	for <virtualization@lists.linux-foundation.org>;
	Tue, 10 Sep 2019 10:15:40 +0000 (UTC)
X-Greylist: domain auto-whitelisted by SQLgrey-1.7.6
Received: from mx1.redhat.com (mx1.redhat.com [209.132.183.28])
	by smtp1.linuxfoundation.org (Postfix) with ESMTPS id 6DFD782B
	for <virtualization@lists.linux-foundation.org>;
	Tue, 10 Sep 2019 10:15:39 +0000 (UTC)
Received: from mail-qt1-f200.google.com (mail-qt1-f200.google.com
	[209.85.160.200])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by mx1.redhat.com (Postfix) with ESMTPS id ACE74C08EC23
	for <virtualization@lists.linux-foundation.org>;
	Tue, 10 Sep 2019 10:15:38 +0000 (UTC)
Received: by mail-qt1-f200.google.com with SMTP id m6so19201641qtk.23
	for <virtualization@lists.linux-foundation.org>;
	Tue, 10 Sep 2019 03:15:38 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
	d=1e100.net; s=20161025;
	h=x-gm-message-state:date:from:to:cc:subject:message-id:references
	:mime-version:content-disposition:in-reply-to;
	bh=zp0tJQdFwr9SMjNLAZ/pzy+YLP+qtmqzIu6ncuWqA/8=;
	b=
X-Gm-Message-State: APjAAAVnFG091DdxbnJftTkKgNKFXMl2E2jLbz1VkbwWmSV+3ZYmRW+E
	PPwBphbIrQ2iNNXIfimklk0ihqfdlUpb/KFmOQ8btlaEee0ZyQbsjwiI9lIYW30j3bTxUCitYCU
	YI7LgRVPqaok69CFl7Acq3cD6js4H0TjgFch75Cpnag==
X-Received: by 2002:ae9:ee1a:: with SMTP id i26mr28231825qkg.112.1568110537859;
...
Received: from redhat.com ([80.74.107.118]) by smtp.gmail.com with ESMTPSA id
	h10sm10207195qtk.18.2019.09.10.03.15.32
