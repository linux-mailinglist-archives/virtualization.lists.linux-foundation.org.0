...
Received: from mail.linuxfoundation.org (mail.linuxfoundation.org [140.211.169.12])
	by mail.lfdr.de (Postfix) with ESMTPS id 529F4F1676
	for <lists.virtualization@lfdr.de>; Wed,  6 Nov 2019 14:01:54 +0100 (CET)
Received: from mail.linux-foundation.org (localhost [127.0.0.1])
	by mail.linuxfoundation.org (Postfix) with ESMTP id 0B671CAF;
	Wed,  6 Nov 2019 12:59:14 +0000 (UTC)
X-Original-To: virtualization@lists.linux-foundation.org
Delivered-To: virtualization@mail.linuxfoundation.org
Received: from smtp1.linuxfoundation.org (smtp1.linux-foundation.org
	[172.17.192.35])
	by mail.linuxfoundation.org (Postfix) with ESMTPS id AFFC3C8E
	for <virtualization@lists.linux-foundation.org>;
	Wed,  6 Nov 2019 12:59:12 +0000 (UTC)
X-Greylist: domain auto-whitelisted by SQLgrey-1.7.6
Received: from mx1.redhat.com (mx1.redhat.com [209.132.183.28])
	by smtp1.linuxfoundation.org (Postfix) with ESMTPS id 094BE189
	for <virtualization@lists.linux-foundation.org>;
	Wed,  6 Nov 2019 12:59:11 +0000 (UTC)
Received: from mail-qt1-f198.google.com (mail-qt1-f198.google.com
	[209.85.160.198])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by mx1.redhat.com (Postfix) with ESMTPS id 667323DD9E
	for <virtualization@lists.linux-foundation.org>;
	Wed,  6 Nov 2019 12:59:10 +0000 (UTC)
Received: by mail-qt1-f198.google.com with SMTP id r12so17404259qtp.21
	for <virtualization@lists.linux-foundation.org>;
	Wed, 06 Nov 2019 04:59:10 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
	d=1e100.net; s=20161025;
	h=x-gm-message-state:date:from:to:cc:subject:message-id:references
	:mime-version:content-disposition:in-reply-to;
	bh=GnlkvgIKriOh4NHkn9TYP1AKjjF4cbq9NeAqGFKfq1c=;
	b=
X-Gm-Message-State: APjAAAXgm/d3NsBVFsW5QP/KexxFwUx5wtCDf8rK1QBxdB++HwVBUCqI
	KMINRuW3+sy/p12uOMEuvRb/ePOwqRMlRqPspP1HomZuGYwnV2QmNX127rTG8buKFA7jlHOqYTS
	VX89k+JIiYmBs4KkXp9ABIJCnMkiJhIvW+Zm3aWIRCg==
X-Received: by 2002:ad4:4894:: with SMTP id bv20mr2006253qvb.132.1573045149347;
...
Received: from redhat.com (bzq-79-178-12-128.red.bezeqint.net. [79.178.12.128])
	...
	t16sm3063901qkm.73.2019.11.06.04.59.04
