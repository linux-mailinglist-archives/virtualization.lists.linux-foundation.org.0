...
Received: from smtp4.osuosl.org (smtp4.osuosl.org [IPv6:2605:bc80:3010::137])
	by mail.lfdr.de (Postfix) with ESMTPS id B82E83E2ACA
	for <lists.virtualization@lfdr.de>; Fri,  6 Aug 2021 14:47:55 +0200 (CEST)
Received: from localhost (localhost [127.0.0.1])
	by smtp4.osuosl.org (Postfix) with ESMTP id 2B856405C2;
	Fri,  6 Aug 2021 12:47:54 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from smtp4.osuosl.org ([127.0.0.1])
	by localhost (smtp4.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
	with ESMTP id zS7KQbBTInY1; Fri,  6 Aug 2021 12:47:53 +0000 (UTC)
Received: from lists.linuxfoundation.org (lf-lists.osuosl.org [140.211.9.56])
	by smtp4.osuosl.org (Postfix) with ESMTPS id A1E6B40581;
	Fri,  6 Aug 2021 12:47:52 +0000 (UTC)
Received: from lf-lists.osuosl.org (localhost [127.0.0.1])
	by lists.linuxfoundation.org (Postfix) with ESMTP id 5A57BC001F;
	Fri,  6 Aug 2021 12:47:52 +0000 (UTC)
X-Original-To: virtualization@lists.linux-foundation.org
Delivered-To: virtualization@lists.linuxfoundation.org
Received: from smtp1.osuosl.org (smtp1.osuosl.org [140.211.166.138])
 by lists.linuxfoundation.org (Postfix) with ESMTP id 4AB25C000E
 for <virtualization@lists.linux-foundation.org>;
 Fri,  6 Aug 2021 12:47:51 +0000 (UTC)
Received: from localhost (localhost [127.0.0.1])
 by smtp1.osuosl.org (Postfix) with ESMTP id 4727183B91
 for <virtualization@lists.linux-foundation.org>;
 Fri,  6 Aug 2021 12:47:51 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
...
Received: from smtp1.osuosl.org ([127.0.0.1])
 ...
 with ESMTP id yk0kX9HNjOD1
 for <virtualization@lists.linux-foundation.org>;
 Fri,  6 Aug 2021 12:47:50 +0000 (UTC)
X-Greylist: domain auto-whitelisted by SQLgrey-1.8.0
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [216.205.24.124])
 by smtp1.osuosl.org (Postfix) with ESMTPS id 1485A83B83
 for <virtualization@lists.linux-foundation.org>;
 Fri,  6 Aug 2021 12:47:49 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1628254069;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=UVJ1BlikKD680IUVJ0Y4iRr3j532xTxJ03Fmskz/bnw=;
 b=LyXLrNcQEw6a/YOdQsdAwEeNX2+wIzF6C/kgmh3eB50pHwLxwYP+fuXgw/l8MNpiB0WLe2
 qvHOIGt1+lnJqoVv38Th6Mt3odzPzHIR/HKzbKnMcBIMbNF6ScqtYttNkTEyvyhxFEoXqO
 5X3GjWZJllN5QJkWFs2rKBa6HqTY/2w=
...
Subject: [PATCH v3 2/9] mm/memory_hotplug: introduce "auto-movable" online
 policy
