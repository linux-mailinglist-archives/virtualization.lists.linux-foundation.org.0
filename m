...
Received: from hemlock.osuosl.org (smtp2.osuosl.org [140.211.166.133])
	by mail.lfdr.de (Postfix) with ESMTPS id 9238611890C
	for <lists.virtualization@lfdr.de>; Tue, 10 Dec 2019 14:01:20 +0100 (CET)
Received: from localhost (localhost [127.0.0.1])
	by hemlock.osuosl.org (Postfix) with ESMTP id 3A87A8810B;
	Tue, 10 Dec 2019 13:01:19 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from hemlock.osuosl.org ([127.0.0.1])
	by localhost (.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
	with ESMTP id eLB6bx64dwdH; Tue, 10 Dec 2019 13:01:09 +0000 (UTC)
Received: from lists.linuxfoundation.org (lf-lists.osuosl.org [140.211.9.56])
	by hemlock.osuosl.org (Postfix) with ESMTP id 12531880F5;
	Tue, 10 Dec 2019 13:01:09 +0000 (UTC)
Received: from lf-lists.osuosl.org (localhost [127.0.0.1])
	by lists.linuxfoundation.org (Postfix) with ESMTP id EB541C0881;
	Tue, 10 Dec 2019 13:01:08 +0000 (UTC)
X-Original-To: virtualization@lists.linux-foundation.org
Delivered-To: virtualization@lists.linuxfoundation.org
Received: from whitealder.osuosl.org (smtp1.osuosl.org [140.211.166.138])
 by lists.linuxfoundation.org (Postfix) with ESMTP id 2DBA6C0881
 for <virtualization@lists.linux-foundation.org>;
 Tue, 10 Dec 2019 13:01:07 +0000 (UTC)
Received: from localhost (localhost [127.0.0.1])
 by whitealder.osuosl.org (Postfix) with ESMTP id 1BEC1860F1
 for <virtualization@lists.linux-foundation.org>;
 Tue, 10 Dec 2019 13:01:07 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from whitealder.osuosl.org ([127.0.0.1])
 by localhost (.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
 with ESMTP id atf3wJwqhryW
 for <virtualization@lists.linux-foundation.org>;
 Tue, 10 Dec 2019 13:00:55 +0000 (UTC)
X-Greylist: domain auto-whitelisted by SQLgrey-1.7.6
Received: from us-smtp-delivery-1.mimecast.com (us-smtp-2.mimecast.com
 [205.139.110.61])
 by whitealder.osuosl.org (Postfix) with ESMTPS id E94FE86174
 for <virtualization@lists.linux-foundation.org>;
 Tue, 10 Dec 2019 13:00:54 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1575982853;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=YjxI+ua/mPZ4k/IeAtr53bquveNdWRXwh+uQx51014k=;
 b=Y7FjSxUaHsCjmZfX3LqsZNIDf/YbjydlHCtt9eldZwTqwPBNn/eflDMTtTEBXN5gl3CBVZ
 480K4bhpdyMAyAm6MhfGTtMF2Pf8lUN6cFb73/psZtRg4TPIMQuukPfS3w+gvfH5eX/GDk
 dzIuYBXqT1d9zzWyTTJrXQn4/Q21XUQ=
Received: from mail-qv1-f70.google.com (mail-qv1-f70.google.com
 [209.85.219.70]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-264-yhMMdA6UMJW1n3BqxwDHTw-1; Tue, 10 Dec 2019 08:00:50 -0500
Received: by mail-qv1-f70.google.com with SMTP id g15so6746675qvk.11
 for <virtualization@lists.linux-foundation.org>;
 Tue, 10 Dec 2019 05:00:50 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:date:from:to:cc:subject:message-id:references
 :mime-version:content-disposition:in-reply-to;
 bh=moL9i+vikLhVXyoOyZB62eDcO/TBsvQ1upl25Mov+HE=;
 b=
X-Gm-Message-State: APjAAAV7lx23xDfnf+L/aajpJK8a7VnUHtaAk/1unpZQ+IMK696cdoVn
 FJp+xU+oC0hmpx88vu3YWr+1aD69dV1EW+K9mSuKECWbofjuXExuMhoPTNTqDMv1vgaQW3LTpFM
 U2I2AAnwtP0x22IcSO/y6dv5uhbAwHqN/eE+LUFNdcA==
X-Received: by 2002:ac8:a83:: with SMTP id d3mr30361921qti.228.1575982846707; 
 Tue, 10 Dec 2019 05:00:46 -0800 (PST)
X-Google-Smtp-Source: APXvYqxy69OAtVWwQkCfG5a/iLFa7cy4r3pPIcO9fiwZrArJGeKBuuTp9IC3i4qZP2xdOHi03mdTsg==
X-Received: by 2002:ac8:a83:: with SMTP id d3mr30361715qti.228.1575982844157; 
 Tue, 10 Dec 2019 05:00:44 -0800 (PST)
Received: from redhat.com (bzq-79-181-48-215.red.bezeqint.net. [79.181.48.215])
 by smtp.gmail.com with ESMTPSA id s34sm1087497qtb.73.2019.12.10.05.00.38
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Tue, 10 Dec 2019 05:00:42 -0800 (PST)
Date: Tue, 10 Dec 2019 08:00:36 -0500
From: "Michael S. Tsirkin" <mst@redhat.com>
To: linux-kernel@vger.kernel.org, Julio Faracco <jcfaracco@gmail.com>
Subject: [PATCH net-next v10 1/3] netdev: pass the stuck queue to the timeout
 handler
Message-ID: <20191210130014.47179-2-mst@redhat.com>
References: <20191210130014.47179-1-mst@redhat.com>
MIME-Version: 1.0
In-Reply-To: <20191210130014.47179-1-mst@redhat.com>
X-Mailer: git-send-email 2.22.0.678.g13338e74b8
X-Mutt-Fcc: =sent
X-MC-Unique: yhMMdA6UMJW1n3BqxwDHTw-1
X-Mimecast-Spam-Score: 0
Content-Disposition: inline
Cc: dnmendes76@gmail.com, Jakub Kicinski <jakub.kicinski@netronome.com>,
 mst@redhat.com, netdev@vger.kernel.org,
 virtualization@lists.linux-foundation.org,
 Martin Habets <mhabets@solarflare.com>, Shannon Nelson <snelson@pensando.io>,
...
index b4b82b9c5cd6..856ebb264e96 100644
...
index 4bb30761abfc..3889089aaadd 100644
...
index 70fd246840e2..aa348230bd39 100644
...
index 2a56e66f58d8..e2499bd9c9b6 100644
--- a/drivers/net/ethernet/mellanox/mlx5/core/en_main.c
+++ b/drivers/net/ethernet/mellanox/mlx5/core/en_main.c
@@ -4340,7 +4340,7 @@ static void mlx5e_tx_timeout_work(struct work_struct *work)
 	rtnl_unlock();
 }
...
index c33c438850cc..2ab6926a32e8 100644
...
index 2fef7402233e..ef13f69f2c73 100644
...
index b2507c59ba8b..de637e353d11 100644
...
index 65e31df37b1f..45ae40ca1858 100644
--- a/drivers/s390/net/qeth_core.h
+++ b/drivers/s390/net/qeth_core.h
@@ -1059,7 +1059,7 @@ void qeth_clear_working_pool_list(struct qeth_card *);
...
index 83794d7494d4..9a4d6473eb3f 100644
