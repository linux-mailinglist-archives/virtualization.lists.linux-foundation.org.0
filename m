...
Received: from smtp2.osuosl.org (smtp2.osuosl.org [140.211.166.133])
	by mail.lfdr.de (Postfix) with ESMTPS id 7B9DD4FBA08
	for <lists.virtualization@lfdr.de>; Mon, 11 Apr 2022 12:47:53 +0200 (CEST)
Received: from localhost (localhost [127.0.0.1])
	by smtp2.osuosl.org (Postfix) with ESMTP id 31333409E8;
	Mon, 11 Apr 2022 10:47:52 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from smtp2.osuosl.org ([127.0.0.1])
	by localhost (smtp2.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
	with ESMTP id 7I86OezJuqAl; Mon, 11 Apr 2022 10:47:49 +0000 (UTC)
Received: from lists.linuxfoundation.org (lf-lists.osuosl.org [140.211.9.56])
	by smtp2.osuosl.org (Postfix) with ESMTPS id 6638F409E9;
	Mon, 11 Apr 2022 10:47:49 +0000 (UTC)
Received: from lf-lists.osuosl.org (localhost [127.0.0.1])
	by lists.linuxfoundation.org (Postfix) with ESMTP id D2AEAC0084;
	Mon, 11 Apr 2022 10:47:48 +0000 (UTC)
X-Original-To: virtualization@lists.linux-foundation.org
Delivered-To: virtualization@lists.linuxfoundation.org
Received: from smtp4.osuosl.org (smtp4.osuosl.org [IPv6:2605:bc80:3010::137])
 by lists.linuxfoundation.org (Postfix) with ESMTP id 7DE7FC002C
 for <virtualization@lists.linux-foundation.org>;
 Mon, 11 Apr 2022 10:47:47 +0000 (UTC)
Received: from localhost (localhost [127.0.0.1])
 by smtp4.osuosl.org (Postfix) with ESMTP id 50022416CE
 for <virtualization@lists.linux-foundation.org>;
 Mon, 11 Apr 2022 10:47:47 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
...
Received: from smtp4.osuosl.org ([127.0.0.1])
 ...
 with ESMTP id LA9XsqMqOR-q
 for <virtualization@lists.linux-foundation.org>;
 Mon, 11 Apr 2022 10:47:45 +0000 (UTC)
X-Greylist: whitelisted by SQLgrey-1.8.0
Received: from mail-pl1-x635.google.com (mail-pl1-x635.google.com
 [IPv6:2607:f8b0:4864:20::635])
 by smtp4.osuosl.org (Postfix) with ESMTPS id EFD49416C5
 for <virtualization@lists.linux-foundation.org>;
 Mon, 11 Apr 2022 10:47:44 +0000 (UTC)
Received: by mail-pl1-x635.google.com with SMTP id n18so13497099plg.5
 for <virtualization@lists.linux-foundation.org>;
 Mon, 11 Apr 2022 03:47:44 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=bytedance-com.20210112.gappssmtp.com; s=20210112;
 h=from:to:cc:subject:date:message-id:in-reply-to:references
 :mime-version:content-transfer-encoding;
 bh=9qR/R+qZ5u1Oa1BM+zEQ/mQPBqdu5pmJwvZIgf3bKec=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=9qR/R+qZ5u1Oa1BM+zEQ/mQPBqdu5pmJwvZIgf3bKec=;
 b=
X-Gm-Message-State: AOAM531B17To5UsQoArxj3ubzo2WXie3H/hX/If/wJbq1p1v4Fpq+i19
 FJ/QjA+Rs7Z0IpaiHqMLiQtwLA==
X-Google-Smtp-Source: ABdhPJxUupvu29rNF5h7rkJvyvju33zeJ4Dq1A70aT4Jy4qeJDEbFodRAHhAhLiLNemtRDDOUKqBUw==
X-Received: by 2002:a17:902:a613:b0:156:b53d:c137 with SMTP id
 u19-20020a170902a61300b00156b53dc137mr31971291plq.73.1649674064210; 
 Mon, 11 Apr 2022 03:47:44 -0700 (PDT)
Received: from always-x1.bytedance.net ([61.120.150.76])
 by smtp.gmail.com with ESMTPSA id
 d8-20020a636808000000b00398e9c7049bsm27541649pgc.31.2022.04.11.03.47.39
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Mon, 11 Apr 2022 03:47:43 -0700 (PDT)
From: zhenwei pi <pizhenwei@bytedance.com>
To: mst@redhat.com,
	berrange@redhat.com,
	arei.gonglei@huawei.com
Subject: [PATCH v4 8/8] crypto: Introduce RSA algorithm
Date: Mon, 11 Apr 2022 18:43:27 +0800
Message-Id: <20220411104327.197048-9-pizhenwei@bytedance.com>
...
---
 ...
 6 files changed, 594 insertions(+), 144 deletions(-)

diff --git a/backends/cryptodev-builtin.c b/backends/cryptodev-builtin.c
index 0671bf9f3e..685bf148b2 100644
...
-
     if (op_info->iv_len > 0) {
         ret = qcrypto_cipher_setiv(sess->cipher, op_info->iv,
                                    op_info->iv_len, errp);
@@ -333,9 +434,95 @@ static int cryptodev_builtin_sym_operation(
...
-
         ...
         if (local_err) {
@@ -177,11 +177,79 @@ virtio_crypto_create_sym_session(VirtIOCrypto *vcrypto,
     }
...
@@ -193,9 +261,8 @@ virtio_crypto_handle_close_session(VirtIOCrypto *vcrypto,
     Error *local_err = NULL;
...
+    g_free(req);
 ...
 static void
@@ -397,6 +483,35 @@ virtio_crypto_sym_input_data_helper(VirtIODevice *vdev,
     }
 }
...
@@ -404,7 +519,10 @@ static void virtio_crypto_req_complete(VirtIOCryptoReq *req, uint8_t status)
...
+
 ...
 {
@@ -595,8 +772,7 @@ virtio_crypto_handle_request(VirtIOCryptoReq *request)
     unsigned out_num;
     uint32_t opcode;
