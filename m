...
Received: from mail.linuxfoundation.org (mail.linuxfoundation.org [140.211.169.12])
	by mail.lfdr.de (Postfix) with ESMTPS id A6FC9173BA
	for <lists.virtualization@lfdr.de>; Wed,  8 May 2019 10:27:48 +0200 (CEST)
Received: from mail.linux-foundation.org (localhost [127.0.0.1])
	by mail.linuxfoundation.org (Postfix) with ESMTP id F2FF5139C;
	Wed,  8 May 2019 08:26:42 +0000 (UTC)
X-Original-To: virtualization@lists.linux-foundation.org
Delivered-To: virtualization@mail.linuxfoundation.org
Received: from smtp1.linuxfoundation.org (smtp1.linux-foundation.org
	[172.17.192.35])
	by mail.linuxfoundation.org (Postfix) with ESMTPS id B4A5F1380
	for <virtualization@lists.linux-foundation.org>;
	Wed,  8 May 2019 08:26:40 +0000 (UTC)
X-Greylist: domain auto-whitelisted by SQLgrey-1.7.6
Received: from mx1.suse.de (mx2.suse.de [195.135.220.15])
	by smtp1.linuxfoundation.org (Postfix) with ESMTPS id AF3B7834
	for <virtualization@lists.linux-foundation.org>;
	Wed,  8 May 2019 08:26:38 +0000 (UTC)
X-Virus-Scanned: by amavisd-new at test-mx.suse.de
Received: from relay2.suse.de (unknown [195.135.220.254])
	by mx1.suse.de (Postfix) with ESMTP id AA695AE28;
...
Subject: [PATCH v5 02/20] drm: Add |struct drm_gem_vram_object| callbacks for
	|struct ttm_bo_driver|
Date: Wed,  8 May 2019 10:26:12 +0200
Message-Id: <20190508082630.15116-3-tzimmermann@suse.de>
