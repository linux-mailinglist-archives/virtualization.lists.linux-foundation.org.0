...
Received: from mail.linuxfoundation.org (mail.linuxfoundation.org [140.211.169.12])
	by mail.lfdr.de (Postfix) with ESMTPS id E0C0C73753
	for <lists.virtualization@lfdr.de>; Wed, 24 Jul 2019 21:07:06 +0200 (CEST)
Received: from mail.linux-foundation.org (localhost [127.0.0.1])
	by mail.linuxfoundation.org (Postfix) with ESMTP id E967D14EE;
	Wed, 24 Jul 2019 18:59:35 +0000 (UTC)
X-Original-To: virtualization@lists.linux-foundation.org
Delivered-To: virtualization@mail.linuxfoundation.org
Received: from smtp1.linuxfoundation.org (smtp1.linux-foundation.org
	[172.17.192.35])
	by mail.linuxfoundation.org (Postfix) with ESMTPS id F074DF0C
	for <virtualization@lists.linux-foundation.org>;
	Fri, 14 Jun 2019 08:38:27 +0000 (UTC)
X-Greylist: delayed 00:39:28 by SQLgrey-1.7.6
Received: from kadath.azazel.net (kadath.azazel.net [81.187.231.250])
	by smtp1.linuxfoundation.org (Postfix) with ESMTPS id EAF52E5
	for <virtualization@lists.linux-foundation.org>;
	Fri, 14 Jun 2019 08:38:26 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=azazel.net; 
	...
	bh=G0kG6tqXXsRGIiO+BHcEtfpdFD2+yHGBJ6x5btZuxkA=;
	b=MvtV+EL3y940ymGGuOgSbcqr9G
...
Received: from kadath.azazel.net ([2001:8b0:135f:bcd1:e2cb:4eff:fedf:e608]
	helo=azazel.net) by kadath.azazel.net with esmtpsa
...
X-Spam-Status: No, score=0.5 required=5.0 tests=BAYES_00,DKIM_SIGNED,
	DKIM_VALID,DKIM_VALID_AU,SORTED_RECIPS autolearn=no version=3.3.1
X-Spam-Checker-Version: SpamAssassin 3.3.1 (2010-03-16) on
	smtp1.linux-foundation.org
X-Mailman-Approved-At: Wed, 24 Jul 2019 18:59:23 +0000
Cc: xdp-newbies@vger.kernel.org, hdanton@sina.com, jakub.kicinski@netronome.com,
	hawk@kernel.org, daniel@iogearbox.net, mst@redhat.com,
...
Content-Type: multipart/mixed; boundary="===============6485423352175856602=="
