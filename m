...
Received: from smtp3.osuosl.org (smtp3.osuosl.org [140.211.166.136])
	by mail.lfdr.de (Postfix) with ESMTPS id EE8C6496285
	for <lists.virtualization@lfdr.de>; Fri, 21 Jan 2022 17:01:09 +0100 (CET)
Received: from localhost (localhost [127.0.0.1])
	by smtp3.osuosl.org (Postfix) with ESMTP id 9F30560F3E;
	Fri, 21 Jan 2022 16:01:08 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from smtp3.osuosl.org ([127.0.0.1])
	by localhost (smtp3.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
	with ESMTP id tsQVGxAfqH_t; Fri, 21 Jan 2022 16:01:07 +0000 (UTC)
Received: from lists.linuxfoundation.org (lf-lists.osuosl.org [IPv6:2605:bc80:3010:104::8cd3:938])
	by smtp3.osuosl.org (Postfix) with ESMTPS id C29F560F96;
	Fri, 21 Jan 2022 16:01:06 +0000 (UTC)
Received: from lf-lists.osuosl.org (localhost [127.0.0.1])
	by lists.linuxfoundation.org (Postfix) with ESMTP id 2CC86C0077;
	Fri, 21 Jan 2022 16:01:06 +0000 (UTC)
X-Original-To: virtualization@lists.linux-foundation.org
Delivered-To: virtualization@lists.linuxfoundation.org
Received: from smtp1.osuosl.org (smtp1.osuosl.org [IPv6:2605:bc80:3010::138])
 by lists.linuxfoundation.org (Postfix) with ESMTP id B191FC002F
 for <virtualization@lists.linux-foundation.org>;
 Fri, 21 Jan 2022 16:01:03 +0000 (UTC)
Received: from localhost (localhost [127.0.0.1])
 by smtp1.osuosl.org (Postfix) with ESMTP id 8B13781AF4
 for <virtualization@lists.linux-foundation.org>;
 Fri, 21 Jan 2022 16:01:03 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from smtp1.osuosl.org ([127.0.0.1])
 by localhost (smtp1.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
 with ESMTP id 4Gc4B68bwiGk
 for <virtualization@lists.linux-foundation.org>;
 Fri, 21 Jan 2022 16:01:01 +0000 (UTC)
X-Greylist: domain auto-whitelisted by SQLgrey-1.8.0
Received: from out30-42.freemail.mail.aliyun.com
 (out30-42.freemail.mail.aliyun.com [115.124.30.42])
 by smtp1.osuosl.org (Postfix) with ESMTPS id 0E04E81AAC
 for <virtualization@lists.linux-foundation.org>;
 Fri, 21 Jan 2022 16:01:00 +0000 (UTC)
X-Alimail-AntiSpam: AC=PASS; BC=-1|-1; BR=01201311R211e4; CH=green; DM=||false|;
 DS=||; FP=0|-1|-1|-1|0|-1|-1|-1; HT=e01e04394; MF=xuanzhuo@linux.alibaba.com;
 NM=1; PH=DS; RN=11; SR=0; TI=SMTPD_---0V2SGnzO_1642780854; 
Received: from localhost(mailfrom:xuanzhuo@linux.alibaba.com
 fp:SMTPD_---0V2SGnzO_1642780854) by smtp.aliyun-inc.com(127.0.0.1);
 Sat, 22 Jan 2022 00:00:55 +0800
MIME-Version: 1.0
message-id: <1642780143.9683533-3-xuanzhuo@linux.alibaba.com>
subject: Re: [PATCH v2 07/12] virtio: queue_reset: pci: support
 VIRTIO_F_RING_RESET
date: Fri, 21 Jan 2022 23:49:03 +0800
from: Xuan Zhuo <xuanzhuo@linux.alibaba.com>
to: Michael S. Tsirkin <mst@redhat.com>
in-reply-to: <20220121104057-mutt-send-email-mst@kernel.org>
...
On Fri, 21 Jan 2022 10:45:09 -0500, Michael S. Tsirkin <mst@redhat.com> wrote:
...
I believe that this version is OK now. Although I have not tested this aspect.
We only need to pass a new ring size in setup_vq() when re-enable.

Regarding the support of resize, the usage scenario I think of is to use
'ethtool -G eth0 512' to modify the queue size of the network card. Although it
is a way to reset all queues based on queue reset. But reset the entire device
can also be achieved. So Do you have any other use cases for queue resize?
