...
Received: from whitealder.osuosl.org (smtp1.osuosl.org [140.211.166.138])
	by mail.lfdr.de (Postfix) with ESMTPS id 5215110A515
	for <lists.virtualization@lfdr.de>; Tue, 26 Nov 2019 21:07:43 +0100 (CET)
Received: from localhost (localhost [127.0.0.1])
	by whitealder.osuosl.org (Postfix) with ESMTP id F3E24822CA;
	Tue, 26 Nov 2019 20:07:41 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from whitealder.osuosl.org ([127.0.0.1])
	by localhost (.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
	with ESMTP id jnq9JIbtQh+V; Tue, 26 Nov 2019 20:06:55 +0000 (UTC)
Received: from lists.linuxfoundation.org (lf-lists.osuosl.org [140.211.9.56])
	by whitealder.osuosl.org (Postfix) with ESMTP id 4EF8686E7F;
	Tue, 26 Nov 2019 20:06:55 +0000 (UTC)
Received: from lf-lists.osuosl.org (localhost [127.0.0.1])
	by lists.linuxfoundation.org (Postfix) with ESMTP id 459EDC1DDB;
	Tue, 26 Nov 2019 20:06:55 +0000 (UTC)
X-Original-To: virtualization@lists.linux-foundation.org
Delivered-To: virtualization@lists.linuxfoundation.org
Received: from silver.osuosl.org (smtp3.osuosl.org [140.211.166.136])
 by lists.linuxfoundation.org (Postfix) with ESMTP id 83224C0880
 for <virtualization@lists.linux-foundation.org>;
 Tue, 26 Nov 2019 20:06:53 +0000 (UTC)
Received: from localhost (localhost [127.0.0.1])
 by silver.osuosl.org (Postfix) with ESMTP id 64F84220A9
 for <virtualization@lists.linux-foundation.org>;
 Tue, 26 Nov 2019 20:06:53 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from silver.osuosl.org ([127.0.0.1])
 by localhost (.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
 with ESMTP id deT6d+ZK6ljA
 for <virtualization@lists.linux-foundation.org>;
 Tue, 26 Nov 2019 20:06:42 +0000 (UTC)
X-Greylist: domain auto-whitelisted by SQLgrey-1.7.6
Received: from mail-qt1-f172.google.com (mail-qt1-f172.google.com
 [209.85.160.172])
 by silver.osuosl.org (Postfix) with ESMTPS id 100AE220E5
 for <virtualization@lists.linux-foundation.org>;
 Tue, 26 Nov 2019 20:06:42 +0000 (UTC)
Received: by mail-qt1-f172.google.com with SMTP id g19so2610000qtv.9
 for <virtualization@lists.linux-foundation.org>;
 Tue, 26 Nov 2019 12:06:41 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmail.com; s=20161025;
 h=from:to:cc:subject:date:message-id:in-reply-to:references;
 bh=HTWI0lFz1EFEIy62cdAejsOR7DQoDnGEzSNDhkJjl2Q=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 :references;
 bh=HTWI0lFz1EFEIy62cdAejsOR7DQoDnGEzSNDhkJjl2Q=;
 b=
X-Gm-Message-State: APjAAAWhkwGxaUHSske5OG2whsfs10YXbejXXZVZsaVt4PuKz7DdbG3X
 xJdat9rPBxtw/oPw7NQABJc=
X-Google-Smtp-Source: APXvYqwffSk+0JMBQGtMURwSlWnCeMFNZX5ojWTzce3ObBomqc94kHiETXsmkUbX3KqcF8F+lXoQGg==
X-Received: by 2002:ac8:288a:: with SMTP id i10mr37018676qti.139.1574798798780; 
 Tue, 26 Nov 2019 12:06:38 -0800 (PST)
Received: from ubuntu.default ([32.104.18.202])
 by smtp.gmail.com with ESMTPSA id d13sm6373562qta.67.2019.11.26.12.06.34
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Tue, 26 Nov 2019 12:06:37 -0800 (PST)
From: Julio Faracco <jcfaracco@gmail.com>
To: netdev@vger.kernel.org
Subject: [net-next V3 1/2] netdev: pass the stuck queue to the timeout handler
Date: Tue, 26 Nov 2019 17:06:27 -0300
Message-Id: <20191126200628.22251-2-jcfaracco@gmail.com>
...
@@ -1545,7 +1545,8 @@ static int ftgmac100_do_ioctl(struct net_device *netdev, struct ifreq *ifr, int
...
@@ -1867,7 +1867,7 @@ static bool hns3_get_tx_timeo_queue_info(struct net_device *ndev)
 	return true;
 }
...
@@ -4338,7 +4338,7 @@ static void mlx5e_tx_timeout_work(struct work_struct *work)
 	rtnl_unlock();
 }
...
@@ -248,7 +248,8 @@ qcauart_netdev_xmit(struct sk_buff *skb, struct net_device *dev)
 	return NETDEV_TX_OK;
 }
...
@@ -5434,7 +5434,7 @@ static void rtl_reset_work(struct rtl8169_private *tp)
 	netif_wake_queue(dev);
 }
...
@@ -3790,7 +3790,7 @@ static int stmmac_napi_poll_tx(struct napi_struct *napi, int budget)
  *   netdev structure and arrange for the device to be reset to a sane state
  *   in order to transmit a new packet.
  */
...
@@ -1189,7 +1190,7 @@ static void tc35815_schedule_restart(struct net_device *dev)
...
+void islpci_eth_tx_timeout(struct net_device *ndev, unsigned int txqueue);
...
@@ -156,7 +156,8 @@ static void qtnf_netdev_get_stats64(struct net_device *ndev,
...
@@ -1072,7 +1072,7 @@ void qeth_clear_working_pool_list(struct qeth_card *);
...
@@ -4294,7 +4294,7 @@ int qeth_set_access_ctrl_online(struct qeth_card *card, int fallback)
 	return rc;
 }
...
@@ -1078,7 +1078,8 @@ static void visornic_set_multi(struct net_device *netdev)
