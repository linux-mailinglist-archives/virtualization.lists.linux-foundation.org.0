...
Received: from mail.linuxfoundation.org (mail.linuxfoundation.org [140.211.169.12])
	by mail.lfdr.de (Postfix) with ESMTPS id 7D80D819B7
	for <lists.virtualization@lfdr.de>; Mon,  5 Aug 2019 14:43:53 +0200 (CEST)
Received: from mail.linux-foundation.org (localhost [127.0.0.1])
	by mail.linuxfoundation.org (Postfix) with ESMTP id D5CD6EC0;
	Mon,  5 Aug 2019 12:43:20 +0000 (UTC)
X-Original-To: virtualization@lists.linux-foundation.org
Delivered-To: virtualization@mail.linuxfoundation.org
Received: from smtp1.linuxfoundation.org (smtp1.linux-foundation.org
	[172.17.192.35])
	by mail.linuxfoundation.org (Postfix) with ESMTPS id 68E1EEA5
	for <virtualization@lists.linux-foundation.org>;
	Mon,  5 Aug 2019 12:43:19 +0000 (UTC)
X-Greylist: domain auto-whitelisted by SQLgrey-1.7.6
Received: from mx1.redhat.com (mx1.redhat.com [209.132.183.28])
	by smtp1.linuxfoundation.org (Postfix) with ESMTPS id 1B57F82F
	for <virtualization@lists.linux-foundation.org>;
	Mon,  5 Aug 2019 12:43:19 +0000 (UTC)
...
Subject: [PATCH v5 16/18] drm/qxl: switch driver from bo->resv to bo->base.resv
...
X-Greylist: Sender IP whitelisted, not delayed by milter-greylist-4.5.16
	...
	Mon, 05 Aug 2019 12:43:18 +0000 (UTC)
...
Cc: thomas@shipmail.org, tzimmermann@suse.de, David Airlie <airlied@linux.ie>,
	...
	daniel@ffwll.ch, "open list:DRM DRIVER FOR QXL VIRTUAL GPU"
