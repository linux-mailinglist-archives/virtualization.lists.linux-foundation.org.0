...
Received: from fraxinus.osuosl.org (smtp4.osuosl.org [140.211.166.137])
	by mail.lfdr.de (Postfix) with ESMTPS id 9E3AA10852A
	for <lists.virtualization@lfdr.de>; Sun, 24 Nov 2019 22:49:24 +0100 (CET)
Received: from localhost (localhost [127.0.0.1])
	by fraxinus.osuosl.org (Postfix) with ESMTP id E50D0854F8;
	Sun, 24 Nov 2019 21:49:22 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from fraxinus.osuosl.org ([127.0.0.1])
	by localhost (.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
	with ESMTP id P3CwiLF0Mnix; Sun, 24 Nov 2019 21:49:07 +0000 (UTC)
Received: from lists.linuxfoundation.org (lf-lists.osuosl.org [140.211.9.56])
	by fraxinus.osuosl.org (Postfix) with ESMTP id 3330385A1E;
	Sun, 24 Nov 2019 21:49:07 +0000 (UTC)
Received: from lf-lists.osuosl.org (localhost [127.0.0.1])
	by lists.linuxfoundation.org (Postfix) with ESMTP id 18D4EC0878;
	Sun, 24 Nov 2019 21:49:07 +0000 (UTC)
X-Original-To: virtualization@lists.linux-foundation.org
Delivered-To: virtualization@lists.linuxfoundation.org
Received: from fraxinus.osuosl.org (smtp4.osuosl.org [140.211.166.137])
 by lists.linuxfoundation.org (Postfix) with ESMTP id 16515C0878
 for <virtualization@lists.linux-foundation.org>;
 Sun, 24 Nov 2019 21:49:05 +0000 (UTC)
Received: from localhost (localhost [127.0.0.1])
 by fraxinus.osuosl.org (Postfix) with ESMTP id E80D184F7A
 for <virtualization@lists.linux-foundation.org>;
 Sun, 24 Nov 2019 21:49:04 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from fraxinus.osuosl.org ([127.0.0.1])
 by localhost (.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
 with ESMTP id uKyrR2arOcjR
 for <virtualization@lists.linux-foundation.org>;
 Sun, 24 Nov 2019 21:48:53 +0000 (UTC)
X-Greylist: domain auto-whitelisted by SQLgrey-1.7.6
Received: from us-smtp-delivery-1.mimecast.com (us-smtp-1.mimecast.com
 [207.211.31.81])
 by fraxinus.osuosl.org (Postfix) with ESMTPS id D01C484E74
 for <virtualization@lists.linux-foundation.org>;
 Sun, 24 Nov 2019 21:48:52 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1574632131;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=tBjAu9Jo1Vo4TewpsFXV4orIgZ1FE3sLhOzbYH4v+6M=;
 b=GjlS2Bp9Yb3pSq9tUTrTlw5zw80jdujb78n7GYutxM6Mr2kVy8UhRz/12biMQwH5xSp4Ac
 fxyUYNMSqqTxbYUjAkm/IsqsVX0bshRTIPFBST+yBxYDPW89NcypW8FdJc5SElkktiPhsP
 3YrQYaWoYcLqVuhuH4EHsbzjSDhrb1U=
Received: from mail-qv1-f69.google.com (mail-qv1-f69.google.com
 [209.85.219.69]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-37-ak8IZ_fKNqu19HYTGHFgWg-1; Sun, 24 Nov 2019 16:48:47 -0500
Received: by mail-qv1-f69.google.com with SMTP id bz8so9018105qvb.9
 for <virtualization@lists.linux-foundation.org>;
 Sun, 24 Nov 2019 13:48:47 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:date:from:to:cc:subject:message-id:references
 :mime-version:content-disposition:in-reply-to;
 bh=M4AJ5Fb3bUdl4SdP4jkoNggLlwDuPTh0yUwFbvruynk=;
 b=
X-Gm-Message-State: APjAAAV88wEgSwTvX0p9o0N3AwBV4qGgmskV1yM7BFcQLGmgy7oi8z2c
 /LY5pYl/cgRL16m3sSoZUo7ZM5xZFYau9NE3FBN0NAatixSYA0WDNW+5XhghO4F2NY4KCnJo/xc
 +ftCpGqu4dZocaaNFmtlgI28GQsDQS+0d0Jj1eqg+kA==
X-Received: by 2002:a05:620a:1663:: with SMTP id
 d3mr7068691qko.204.1574632125141; 
 Sun, 24 Nov 2019 13:48:45 -0800 (PST)
X-Google-Smtp-Source: APXvYqz5SvwxEuz6WRKo20JmFvYGzlP2nGS6XinaOk2ELGXBrQl5JceTQ8pH3qbJ6GZUaGSb1fIEaA==
X-Received: by 2002:a05:620a:1663:: with SMTP id
 d3mr7068604qko.204.1574632122829; 
 Sun, 24 Nov 2019 13:48:42 -0800 (PST)
Received: from redhat.com (bzq-79-176-6-42.red.bezeqint.net. [79.176.6.42])
 by smtp.gmail.com with ESMTPSA id g25sm2771721qtc.90.2019.11.24.13.48.37
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Sun, 24 Nov 2019 13:48:41 -0800 (PST)
Date: Sun, 24 Nov 2019 16:48:35 -0500
...
Message-ID: <20191124164411-mutt-send-email-mst@kernel.org>
...
MIME-Version: 1.0
In-Reply-To: <20191124100157-mutt-send-email-mst@kernel.org>
X-MC-Unique: ak8IZ_fKNqu19HYTGHFgWg-1
...
untested. One good thing is this is all compile time errors, once it
passes kbuild we can be reasonably sure it's doing the right thing
though.
...
for my $p (@work) {
	...
	our @ARGV = ($file);
	while (<ARGV>) {
		if (m/($func\s*\(struct\s+net_device\s+\*[A-Za-z_]?[A-Za-z-0-9]*)(\))/) {
			print STDERR "found $1+$2 in $file\n";
		}
		if (s/($func\s*\(struct\s+net_device\s+\*[A-Za-z_]?[A-Za-z-0-9]*)(\))/$1, int txqueue$2/) {
...
index b0f5bc07aef5..c5d5d4b821a3 100644
...
index 3da97996bdf3..8c7498aa8870 100644
...
+el3_tx_timeout (struct net_device *dev, int txqueue)
 {
 	int ioaddr = dev->base_addr;
...
index 3e2f2c2e7b58..beedf7805fda 100644
...
index ab30761003da..e9d1fe2182c7 100644
...
+void lance_tx_timeout(struct net_device *dev, int txqueue)
 {
 	printk("lance_tx_timeout\n");
 	lance_reset(dev);
diff --git a/drivers/net/ethernet/amd/7990.h b/drivers/net/ethernet/amd/7990.h
index 741cdc392c6b..649bcea68739 100644
...
index d3d44e07afbc..e08db6061131 100644
...
index f90b454b1642..f789de71b40e 100644
...
index d10b421ed1f1..78f2281d2e9a 100644
...
+void bnx2x_tx_timeout(struct net_device *dev, int txqueue)
 {
 	struct bnx2x *bp = netdev_priv(dev);
 
diff --git a/drivers/net/ethernet/broadcom/bnx2x/bnx2x_cmn.h b/drivers/net/ethernet/broadcom/bnx2x/bnx2x_cmn.h
index 8b08cb18e363..46d5a898e56e 100644
...
index 1604ad32e920..571c7a633266 100644
...
+static void sbmac_tx_timeout (struct net_device *dev, int txqueue);
...
index f1a2da15dd0a..de849e7d2f06 100644
...
+static void de_tx_timeout (struct net_device *dev, int txqueue)
 {
...
index 55e720d2ea0c..363f4789b3cb 100644
...
+static void rio_tx_timeout (struct net_device *dev, int txqueue);
...
+rio_tx_timeout (struct net_device *dev, int txqueue)
 {
 	struct netdev_private *np = netdev_priv(dev);
...
index 92929750f832..7e15af5b6039 100644
...
+static void i596_tx_timeout (struct net_device *dev, int txqueue);
...
index f9742af7f142..6fe4211b17b5 100644
...
@@ -166,7 +166,7 @@ static ssize_t ixgbe_dbg_netdev_ops_write(struct file *filp,
 	ixgbe_dbg_netdev_ops_buf[len] = '\0';
 
 	if (strncmp(ixgbe_dbg_netdev_ops_buf, "tx_timeout", 10) == 0) {
-		adapter->netdev->netdev_ops->ndo_tx_timeout(adapter->netdev);
+		adapter->netdev->netdev_ops->ndo_tx_timeout(adapter->netdev, -1);
...
index b339125b2f09..3a7bcd101e11 100644
...
+static void sonic_tx_timeout(struct net_device *dev, int txqueue)
 {
 	struct sonic_local *lp = netdev_priv(dev);
 	int i;
diff --git a/drivers/net/ethernet/natsemi/sonic.h b/drivers/net/ethernet/natsemi/sonic.h
index 2b27f7049acb..f2d976835d3a 100644
...
index 0a921f30f98f..70e5217b852c 100644
...
+static void qcauart_netdev_tx_timeout(struct net_device *dev, int txqueue)
 {
...
index 8b94d9ad9e2b..ef6cb6d7dc77 100644
...
+void sunvnet_tx_timeout_common(struct net_device *dev, int txqueue)
 {
 	/* XXX Implement me XXX */
 }
diff --git a/drivers/net/ethernet/sun/sunvnet_common.h b/drivers/net/ethernet/sun/sunvnet_common.h
index 2b808d2482d6..e346a79102fb 100644
...
index 051033580f0a..31240c81664c 100644
...
index b517c1af9de0..7691d4fd3a3f 100644
...
+static void fjes_tx_retry(struct net_device *, int txqueue);
...
index dde05e2fdc3e..1faadb6073a1 100644
...
+void usbnet_tx_timeout (struct net_device *net, int txqueue)
 {
...
index 430862a6a24b..c138ef4edf71 100644
...
index 2b8fb07d07e7..ee53ba543e9b 100644
...
+islpci_eth_tx_timeout(struct net_device *ndev, int txqueue)
 {
...
index 61f4b43c6054..5f571bf96dd4 100644
...
+void islpci_eth_tx_timeout(struct net_device *, int txqueue);
...
index e4b55f9aa062..aa5fd99145f0 100644
...
+void qeth_tx_timeout(struct net_device *, int txqueue);
 void qeth_prepare_ipa_cmd(struct qeth_card *card, struct qeth_cmd_buffer *iob,
 			  u16 cmd_length);
 int qeth_query_switch_attributes(struct qeth_card *card,
diff --git a/drivers/s390/net/qeth_core_main.c b/drivers/s390/net/qeth_core_main.c
index dda274351c21..2d5c4c827b60 100644
...
+void qeth_tx_timeout(struct net_device *dev, int txqueue)
 {
...
+static void p80211knetdev_tx_timeout(struct net_device *netdev, int txqueue);
...
index d8860f2d0976..af45e185312c 100644
...
+extern void usbnet_tx_timeout(struct net_device *net, int txqueue);
