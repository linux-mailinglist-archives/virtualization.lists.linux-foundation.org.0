...
Received: from smtp3.osuosl.org (smtp3.osuosl.org [140.211.166.136])
	by mail.lfdr.de (Postfix) with ESMTPS id D756F3B9D2B
	for <lists.virtualization@lfdr.de>; Fri,  2 Jul 2021 09:54:51 +0200 (CEST)
Received: from localhost (localhost [127.0.0.1])
	by smtp3.osuosl.org (Postfix) with ESMTP id 540536087F;
	Fri,  2 Jul 2021 07:54:50 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from smtp3.osuosl.org ([127.0.0.1])
	by localhost (smtp3.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
	with ESMTP id 5KqoCD93iK4i; Fri,  2 Jul 2021 07:54:47 +0000 (UTC)
Received: from lists.linuxfoundation.org (lf-lists.osuosl.org [IPv6:2605:bc80:3010:104::8cd3:938])
	by smtp3.osuosl.org (Postfix) with ESMTPS id 5EB63606F0;
	Fri,  2 Jul 2021 07:54:47 +0000 (UTC)
Received: from lf-lists.osuosl.org (localhost [127.0.0.1])
	by lists.linuxfoundation.org (Postfix) with ESMTP id 34F27C001F;
	Fri,  2 Jul 2021 07:54:47 +0000 (UTC)
X-Original-To: virtualization@lists.linux-foundation.org
Delivered-To: virtualization@lists.linuxfoundation.org
Received: from smtp2.osuosl.org (smtp2.osuosl.org [IPv6:2605:bc80:3010::133])
 by lists.linuxfoundation.org (Postfix) with ESMTP id 9D3A7C000E
 for <virtualization@lists.linux-foundation.org>;
 Fri,  2 Jul 2021 07:54:44 +0000 (UTC)
Received: from localhost (localhost [127.0.0.1])
 by smtp2.osuosl.org (Postfix) with ESMTP id 75062400BF
 for <virtualization@lists.linux-foundation.org>;
 Fri,  2 Jul 2021 07:54:44 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Authentication-Results: smtp2.osuosl.org (amavisd-new);
 dkim=pass (1024-bit key) header.d=suse.de header.b="F5y2i8tL";
 dkim=neutral reason="invalid (unsupported algorithm ed25519-sha256)"
 header.d=suse.de header.b="vtCXSejA"; dkim=pass (1024-bit key)
 header.d=suse.de header.b="F5y2i8tL"; dkim=neutral
 reason="invalid (unsupported algorithm ed25519-sha256)"
 header.d=suse.de header.b="vtCXSejA"
Received: from smtp2.osuosl.org ([127.0.0.1])
 by localhost (smtp2.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
 with ESMTP id dDvjgrxTcdTK
 for <virtualization@lists.linux-foundation.org>;
 Fri,  2 Jul 2021 07:54:40 +0000 (UTC)
X-Greylist: domain auto-whitelisted by SQLgrey-1.8.0
Received: from smtp-out2.suse.de (smtp-out2.suse.de [195.135.220.29])
 by smtp2.osuosl.org (Postfix) with ESMTPS id 0A9A8400DD
 for <virtualization@lists.linux-foundation.org>;
 Fri,  2 Jul 2021 07:54:39 +0000 (UTC)
Received: from imap.suse.de (imap-alt.suse-dmz.suse.de [192.168.254.47])
 (using TLSv1.2 with cipher ECDHE-ECDSA-AES128-GCM-SHA256 (128/128 bits))
 (No client certificate requested)
 by smtp-out2.suse.de (Postfix) with ESMTPS id 5949120533;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=suse.de; s=susede2_rsa;
 ...
 bh=WgxVTE7U1jbWBA9CwH1kuCqdLMZKPj5DLGZTve3UGVk=;
 b=F5y2i8tLmUil+fdjmVrVU5CzMA8USCh2hItAEIVhraKc93paCsX9nDBtosjMBfLn4yQWiO
 +PDqMyLwiGwD3lJ4rNT4Vwz5d1+pUMDfHXOVcqA6meG7Ynpbk7huWi4CGfP8U6AGlwo6m0
 Qm7n1XQMEwObcUsuc74RyNxPUIXPIH0=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=suse.de;
 ...
 in-reply-to:in-reply-to:references:references;
 bh=WgxVTE7U1jbWBA9CwH1kuCqdLMZKPj5DLGZTve3UGVk=;
 b=vtCXSejANxB/AFR8PIMTqj2Eip4i2l8H9BiJyNzYecDyrltiT+dDj6DCd4fDgsmfqJcEjG
 jV+mEsV4t78NP7DQ==
Received: from imap3-int (imap-alt.suse-dmz.suse.de [192.168.254.47])
 by imap.suse.de (Postfix) with ESMTP id 058D511CD6;
...
Subject: [PATCH v2 1/3] drm/bochs: Move to tiny/
Date: Fri,  2 Jul 2021 09:54:32 +0200
Message-Id: <20210702075434.27677-2-tzimmermann@suse.de>
