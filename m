43
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Fri, 22 Nov 2019 05:53:47 -0800 (PST)
Date: Fri, 22 Nov 2019 08:53:41 -0500
...
Message-ID: <20191122080233-mutt-send-email-mst@kernel.org>
...
MIME-Version: 1.0
In-Reply-To: <CAENf94KX1XR4_KXz9KLZQ09Ngeaq2qzYY5OE68xJMXMu13SuEg@mail.gmail.com>
X-MC-Unique: XAd4uSwcMEeoq0fdVIXxqQ-1
...
> Em sex., 22 de nov. de 2019 =E0s 07:31, Michael S. Tsirkin
...
> > >
> > > This commit brings back virtnet_reset method to recover TX queues fro=
m a
> > > error state. That function is called by schedule_work method and it p=
uts
...
> > > @@ -98,6 +99,7 @@ static const struct virtnet_stat_desc virtnet_sq_st=
ats_desc[] =3D {
...
> > >
> > > @@ -1721,7 +1726,7 @@ static void virtnet_stats(struct net_device *de=
v,
> > >       int i;
> > >
...
> > >
> > > @@ -1729,6 +1734,7 @@ static void virtnet_stats(struct net_device *de=
v,
> > >                       start =3D u64_stats_fetch_begin_irq(&sq->stats.=
syncp);
> > >                       tpackets =3D sq->stats.packets;
> > >                       tbytes   =3D sq->stats.bytes;
> > > +                     terrors  =3D sq->stats.tx_timeouts;
> > >               } while (u64_stats_fetch_retry_irq(&sq->stats.syncp, st=
art));
> > >
> > >               do {
> > > @@ -1743,6 +1749,7 @@ static void virtnet_stats(struct net_device *de=
v,
...
> > > @@ -2578,6 +2585,33 @@ static int virtnet_set_features(struct net_dev=
ice *dev,
> > >       return 0;
> > >  }
> > >
...
for my $p (@work) {
	...
	our @ARGV =3D ($file);
	while (<ARGV>) {
		if (m/($func\(struct\s+net_device\s+\*[A-Za-z_][A-Za-z-0-9]*)(\))/) {
			print STDERR "found $1+$2 in $file\n";
		}
		if (s/($func\(struct\s+net_device\s+\*[A-Za-z_][A-Za-z-0-9]*)(\))/$1, int=
 txqueue$2/) {
...
> Or we can keep the default WARN_ONCE, but we need a minimum method implem=
ented.
...
>                                   round_jiffies(jiffies + dev->watchdog_t=
imeo)))
>                            dev_hold(dev);
>            }
>     }
...
> > > @@ -2593,6 +2627,7 @@ static const struct net_device_ops virtnet_netd=
ev =3D {
...
> > > @@ -2982,6 +3017,62 @@ static int virtnet_validate(struct virtio_devi=
ce *vdev)
> > >       return 0;
> > >  }
> > >
...
> > > +     vdev->failed =3D vdev->config->get_status(vdev) & VIRTIO_CONFIG=
_S_FAILED;
> > > +
...
> IMHO virtio net has a nice performance. You can take days to see a TX tim=
eout.
...
+static void ariadne_tx_timeout(struct net_device *dev, int txqueue)
 {
 	volatile struct Am79C960 *lance =3D (struct Am79C960 *)dev->base_addr;
 =
...
+static void p80211knetdev_tx_timeout(struct net_device *netdev, int txqueu=
e);
...
@@ -446,7 +446,7 @@ static void dev_watchdog(struct timer_list *t)
 				...
 				WARN_ONCE(1, KERN_INFO "NETDEV WATCHDOG: %s (%s): transmit queue %u ti=
med out\n",
