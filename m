...
Received: from smtp2.osuosl.org (smtp2.osuosl.org [IPv6:2605:bc80:3010::133])
	by mail.lfdr.de (Postfix) with ESMTPS id 806AE661431
	for <lists.virtualization@lfdr.de>; Sun,  8 Jan 2023 09:53:11 +0100 (CET)
Received: from localhost (localhost [127.0.0.1])
	by smtp2.osuosl.org (Postfix) with ESMTP id 3E3C240220;
	Sun,  8 Jan 2023 08:53:08 +0000 (UTC)
DKIM-Filter: OpenDKIM Filter v2.11.0 smtp2.osuosl.org 3E3C240220
Authentication-Results: smtp2.osuosl.org;
	dkim=fail reason="signature verification failed" (2048-bit key) header.d=solid-run-com.20210112.gappssmtp.com header.i=@solid-run-com.20210112.gappssmtp.com header.a=rsa-sha256 header.s=20210112 header.b=BZ1bhuhV
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from smtp2.osuosl.org ([127.0.0.1])
	by localhost (smtp2.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
	with ESMTP id Wi10G9ULxhEG; Sun,  8 Jan 2023 08:53:05 +0000 (UTC)
Received: from lists.linuxfoundation.org (lf-lists.osuosl.org [140.211.9.56])
	by smtp2.osuosl.org (Postfix) with ESMTPS id 2B24F40123;
	Sun,  8 Jan 2023 08:53:05 +0000 (UTC)
DKIM-Filter: OpenDKIM Filter v2.11.0 smtp2.osuosl.org 2B24F40123
Received: from lf-lists.osuosl.org (localhost [127.0.0.1])
	by lists.linuxfoundation.org (Postfix) with ESMTP id 5837AC007B;
	Sun,  8 Jan 2023 08:53:04 +0000 (UTC)
X-Original-To: virtualization@lists.linux-foundation.org
Delivered-To: virtualization@lists.linuxfoundation.org
Received: from smtp2.osuosl.org (smtp2.osuosl.org [IPv6:2605:bc80:3010::133])
 by lists.linuxfoundation.org (Postfix) with ESMTP id 99A53C002D
 for <virtualization@lists.linux-foundation.org>;
 Sun,  8 Jan 2023 08:53:02 +0000 (UTC)
Received: from localhost (localhost [127.0.0.1])
 by smtp2.osuosl.org (Postfix) with ESMTP id 600C740123
 for <virtualization@lists.linux-foundation.org>;
 Sun,  8 Jan 2023 08:53:02 +0000 (UTC)
DKIM-Filter: OpenDKIM Filter v2.11.0 smtp2.osuosl.org 600C740123
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from smtp2.osuosl.org ([127.0.0.1])
 by localhost (smtp2.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
 with ESMTP id uH4yqFMZ_1vI
 for <virtualization@lists.linux-foundation.org>;
 Sun,  8 Jan 2023 08:52:59 +0000 (UTC)
X-Greylist: whitelisted by SQLgrey-1.8.0
DKIM-Filter: OpenDKIM Filter v2.11.0 smtp2.osuosl.org 447254011D
Received: from mail-wr1-x432.google.com (mail-wr1-x432.google.com
 [IPv6:2a00:1450:4864:20::432])
 by smtp2.osuosl.org (Postfix) with ESMTPS id 447254011D
 for <virtualization@lists.linux-foundation.org>;
 Sun,  8 Jan 2023 08:52:59 +0000 (UTC)
Received: by mail-wr1-x432.google.com with SMTP id r2so5235747wrv.7
 for <virtualization@lists.linux-foundation.org>;
 Sun, 08 Jan 2023 00:52:59 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=solid-run-com.20210112.gappssmtp.com; s=20210112;
 h=content-transfer-encoding:mime-version:message-id:date:subject:cc
 :to:from:from:to:cc:subject:date:message-id:reply-to;
 bh=iytpI9S+FaWfXXSpQfCVHuj1loiG3IPa0ny0S8F4b4s=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 :reply-to;
 bh=iytpI9S+FaWfXXSpQfCVHuj1loiG3IPa0ny0S8F4b4s=;
 b=
X-Gm-Message-State: AFqh2kp+q0cLALTuCnCznS/S+w2IEWex58TNh72IxtmKC40d4trE4jLj
 cK8Kwn8n7c0bWCCONJFNlKuHuBYe9xTVMEFE
X-Google-Smtp-Source: AMrXdXsJHHid5yVg5vky8XbZldL6LN4mEMM/EHjF8nu8y1ilzQ/TnbY+shPR9DbVQTCGcsmBOYcTrA==
X-Received: by 2002:a5d:4fd2:0:b0:26f:893c:c21 with SMTP id
 h18-20020a5d4fd2000000b0026f893c0c21mr36632969wrw.45.1673167976032; 
 Sun, 08 Jan 2023 00:52:56 -0800 (PST)
Received: from localhost.localdomain
 (bzq-84-110-153-254.static-ip.bezeqint.net. [84.110.153.254])
 by smtp.gmail.com with ESMTPSA id
 l7-20020a5d6747000000b002b57bae7174sm5715981wrw.5.2023.01.08.00.52.54
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Sun, 08 Jan 2023 00:52:55 -0800 (PST)
From: Alvaro Karsz <alvaro.karsz@solid-run.com>
To: virtualization@lists.linux-foundation.org
Subject: [PATCH v7] virtio: vdpa: new SolidNET DPU driver.
Date: Sun,  8 Jan 2023 10:52:52 +0200
Message-Id: <20230108085252.403248-1-alvaro.karsz@solid-run.com>
...
v6:
	- SNET_WRN -> SNET_WARN.
v7:
	- Explain the dependency of SNET_VDPA on HWMON in Kconfig.
	...
	- Fix kernel warning in snet_vdpa_remove_vf.
	  ...
	  directory 'irq/..', leaking at least '..'" warnings.
	- Remove the psnet_create_hwmon function empty definition if
	  ...
	  with W=1.
	  This was reported by kernel test robot <lkp@intel.com>.
---
 MAINTAINERS                        |    4 +
