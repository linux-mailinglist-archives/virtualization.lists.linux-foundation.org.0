...
Received: from mail.linuxfoundation.org (mail.linuxfoundation.org [140.211.169.12])
	by mail.lfdr.de (Postfix) with ESMTPS id BF2FEEABCB
	for <lists.virtualization@lfdr.de>; Thu, 31 Oct 2019 09:50:41 +0100 (CET)
Received: from mail.linux-foundation.org (localhost [127.0.0.1])
	by mail.linuxfoundation.org (Postfix) with ESMTP id 9B625C6D;
	Thu, 31 Oct 2019 08:50:34 +0000 (UTC)
X-Original-To: virtualization@lists.linux-foundation.org
Delivered-To: virtualization@mail.linuxfoundation.org
Received: from smtp1.linuxfoundation.org (smtp1.linux-foundation.org
	[172.17.192.35])
	by mail.linuxfoundation.org (Postfix) with ESMTPS id E3DDBA7F
	for <virtualization@lists.linux-foundation.org>;
	Thu, 31 Oct 2019 08:50:33 +0000 (UTC)
X-Greylist: domain auto-whitelisted by SQLgrey-1.7.6
Received: from mx1.redhat.com (mx1.redhat.com [209.132.183.28])
	by smtp1.linuxfoundation.org (Postfix) with ESMTPS id 26C38174
	for <virtualization@lists.linux-foundation.org>;
	Thu, 31 Oct 2019 08:50:31 +0000 (UTC)
Received: from mail-wm1-f70.google.com (mail-wm1-f70.google.com
	[209.85.128.70])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by mx1.redhat.com (Postfix) with ESMTPS id E6C8637F73
	for <virtualization@lists.linux-foundation.org>;
	Thu, 31 Oct 2019 08:50:29 +0000 (UTC)
Received: by mail-wm1-f70.google.com with SMTP id k9so2095317wmb.0
	for <virtualization@lists.linux-foundation.org>;
	Thu, 31 Oct 2019 01:50:29 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
	d=1e100.net; s=20161025;
	h=x-gm-message-state:date:from:to:cc:subject:message-id:references
	:mime-version:content-disposition:in-reply-to:user-agent;
	bh=oaX09C79dj+CrWDwYtUCmw850lgrDEb634tch2TvtRo=;
	b=
X-Gm-Message-State: APjAAAXxhOAwj/z4x7CUVCXbheIMImCBP+orUmEKSE1uw0dGsJKdoPKZ
	rdC+w+WpWW14fify6D5GsxBhtKpeepk4rSWym/BF1VGYEwYk6xhQ3XGOXST3o68BuRHdZUHGgIx
	wM52yk2m0GHIUdiC350F1IxH/Uwfef7XO63W/tr8jFw==
X-Received: by 2002:a1c:99cd:: with SMTP id b196mr3941768wme.105.1572511828438;
...
X-Received: by 2002:a1c:99cd:: with SMTP id b196mr3941733wme.105.1572511828065;
	Thu, 31 Oct 2019 01:50:28 -0700 (PDT)
Received: from steredhat ([91.217.168.176]) by smtp.gmail.com with ESMTPSA id
	o25sm3585866wro.21.2019.10.31.01.50.26
	(version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
	Thu, 31 Oct 2019 01:50:27 -0700 (PDT)
Date: Thu, 31 Oct 2019 09:50:25 +0100
From: Stefano Garzarella <sgarzare@redhat.com>
To: Jorgen Hansen <jhansen@vmware.com>, Dexuan Cui <decui@microsoft.com>
