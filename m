...
Received: from fraxinus.osuosl.org (smtp4.osuosl.org [140.211.166.137])
	by mail.lfdr.de (Postfix) with ESMTPS id D50BD2C424E
	for <lists.virtualization@lfdr.de>; Wed, 25 Nov 2020 15:45:18 +0100 (CET)
Received: from localhost (localhost [127.0.0.1])
	by fraxinus.osuosl.org (Postfix) with ESMTP id 86A8B86DAC;
	Wed, 25 Nov 2020 14:45:17 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from fraxinus.osuosl.org ([127.0.0.1])
	by localhost (.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
	with ESMTP id Xz2YwuOSu4dk; Wed, 25 Nov 2020 14:45:16 +0000 (UTC)
Received: from lists.linuxfoundation.org (lf-lists.osuosl.org [140.211.9.56])
	by fraxinus.osuosl.org (Postfix) with ESMTP id E959786DAF;
	Wed, 25 Nov 2020 14:45:16 +0000 (UTC)
Received: from lf-lists.osuosl.org (localhost [127.0.0.1])
	by lists.linuxfoundation.org (Postfix) with ESMTP id BB652C0052;
	Wed, 25 Nov 2020 14:45:16 +0000 (UTC)
X-Original-To: virtualization@lists.linux-foundation.org
Delivered-To: virtualization@lists.linuxfoundation.org
Received: from whitealder.osuosl.org (smtp1.osuosl.org [140.211.166.138])
 by lists.linuxfoundation.org (Postfix) with ESMTP id B89D6C0052
 for <virtualization@lists.linux-foundation.org>;
 Wed, 25 Nov 2020 14:45:15 +0000 (UTC)
Received: from localhost (localhost [127.0.0.1])
 by whitealder.osuosl.org (Postfix) with ESMTP id 945D48711A
 for <virtualization@lists.linux-foundation.org>;
 Wed, 25 Nov 2020 14:45:15 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from whitealder.osuosl.org ([127.0.0.1])
 by localhost (.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
 with ESMTP id yBT2GXgsAjUQ
 for <virtualization@lists.linux-foundation.org>;
 Wed, 25 Nov 2020 14:45:14 +0000 (UTC)
X-Greylist: domain auto-whitelisted by SQLgrey-1.7.6
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
 by whitealder.osuosl.org (Postfix) with ESMTPS id 7D0CD87126
 for <virtualization@lists.linux-foundation.org>;
 Wed, 25 Nov 2020 14:45:14 +0000 (UTC)
IronPort-SDR: q+1gKGUiFgH1h347HVQIdXWpMRXGbyesbqy5W6FqCsDMBg3D0wo6W7bXuGEyuZ2To4vGIodQ6l
 MLyYOP0/5T8Q==
X-IronPort-AV: E=McAfee;i="6000,8403,9815"; a="172298046"
X-IronPort-AV: E=Sophos;i="5.78,369,1599548400"; 
 d="gz'50?scan'50,208,50";a="172298046"
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Nov 2020 06:45:13 -0800
IronPort-SDR: P39qTj3GNpzzropW2oklF6O/dpZyQ7etXaO5A07kSNUnAQpBbNGFKFp9/5UlDT0Y0yp1dtA5ob
 UeWdBkMMloRw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.78,369,1599548400"; 
 d="gz'50?scan'50,208,50";a="478955821"
Received: from lkp-server01.sh.intel.com (HELO f59a693d3a73) ([10.239.97.150])
 by orsmga004.jf.intel.com with ESMTP; 25 Nov 2020 06:45:10 -0800
Received: from kbuild by f59a693d3a73 with local (Exim 4.92)
 (envelope-from <lkp@intel.com>)
 id 1khw2g-0000AB-0W; Wed, 25 Nov 2020 14:45:10 +0000
Date: Wed, 25 Nov 2020 22:44:12 +0800
From: kernel test robot <lkp@intel.com>
To: Adalbert =?utf-8?B?TGF6xINy?= <alazar@bitdefender.com>, kvm@vger.kernel.org
Subject: Re: [PATCH v10 75/81] KVM: introspection: add KVMI_VCPU_EVENT_PF
Message-ID: <202011252229.u8h8wI0P-lkp@intel.com>
References: <20201125093600.2766-76-alazar@bitdefender.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="0OAP2g/MAC+5xKAE"
Content-Disposition: inline
In-Reply-To: <20201125093600.2766-76-alazar@bitdefender.com>
...
All warnings (new ones prefixed by >>):
   ...
   arch/x86/kvm/../../../virt/kvm/introspection/kvmi.c:481:5: warning: no previous prototype for 'kvmi_hook' [-Wmissing-prototypes]
     481 | int kvmi_hook(struct kvm *kvm, const struct kvm_introspection_hook *hook)
         |     ^~~~~~~~~
>> arch/x86/kvm/../../../virt/kvm/introspection/kvmi.c:1076:6: warning: no previous prototype for 'kvmi_restricted_page_access' [-Wmissing-prototypes]
    1076 | bool kvmi_restricted_page_access(struct kvm_introspection *kvmi, gpa_t gpa,
         |      ^~~~~~~~~~~~~~~~~~~~~~~~~~~

vim +/kvmi_restricted_page_access +1076 arch/x86/kvm/../../../virt/kvm/introspection/kvmi.c
...
> 1076	bool kvmi_restricted_page_access(struct kvm_introspection *kvmi, gpa_t gpa,
  ...
  1080		int err;
  1081	
  1082		err = kvmi_get_gfn_access(kvmi, gpa_to_gfn(gpa), &allowed_access);
  1083		if (err)
  1084			return false;
  1085	
  1086		/*
...
H4sICDljvl8AAy5jb25maWcAlDzJdty2svt8RR9nkyziK8my4px3tABJsBtukqABsAdtcBS5
