...
Received: from whitealder.osuosl.org (smtp1.osuosl.org [140.211.166.138])
	by mail.lfdr.de (Postfix) with ESMTPS id 90E0E2C3F4F
	for <lists.virtualization@lfdr.de>; Wed, 25 Nov 2020 12:50:02 +0100 (CET)
Received: from localhost (localhost [127.0.0.1])
	by whitealder.osuosl.org (Postfix) with ESMTP id 1A798857D8;
	Wed, 25 Nov 2020 11:50:01 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from whitealder.osuosl.org ([127.0.0.1])
	by localhost (.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
	with ESMTP id IiL6H9ls5W02; Wed, 25 Nov 2020 11:49:57 +0000 (UTC)
Received: from lists.linuxfoundation.org (lf-lists.osuosl.org [140.211.9.56])
	by whitealder.osuosl.org (Postfix) with ESMTP id 9B76086884;
	Wed, 25 Nov 2020 11:49:57 +0000 (UTC)
Received: from lf-lists.osuosl.org (localhost [127.0.0.1])
	by lists.linuxfoundation.org (Postfix) with ESMTP id 74CC7C0052;
	Wed, 25 Nov 2020 11:49:57 +0000 (UTC)
X-Original-To: virtualization@lists.linux-foundation.org
Delivered-To: virtualization@lists.linuxfoundation.org
Received: from fraxinus.osuosl.org (smtp4.osuosl.org [140.211.166.137])
 by lists.linuxfoundation.org (Postfix) with ESMTP id 3AA00C0052
 for <virtualization@lists.linux-foundation.org>;
 Wed, 25 Nov 2020 11:49:56 +0000 (UTC)
Received: from localhost (localhost [127.0.0.1])
 by fraxinus.osuosl.org (Postfix) with ESMTP id 2AD6586CFF
 for <virtualization@lists.linux-foundation.org>;
 Wed, 25 Nov 2020 11:49:56 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from fraxinus.osuosl.org ([127.0.0.1])
 by localhost (.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
 with ESMTP id uXU0F5MX7Be4
 for <virtualization@lists.linux-foundation.org>;
 Wed, 25 Nov 2020 11:49:55 +0000 (UTC)
X-Greylist: domain auto-whitelisted by SQLgrey-1.7.6
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 by fraxinus.osuosl.org (Postfix) with ESMTPS id 31D278350D
 for <virtualization@lists.linux-foundation.org>;
 Wed, 25 Nov 2020 11:49:55 +0000 (UTC)
IronPort-SDR: FjYJbGde4dAB/TxvJZj1goEyuEMelEB888fUJPCdUA4x5cdOioD9dQbruyd69El/MtVX0e62MN
 7lnKnQBS2qqg==
X-IronPort-AV: E=McAfee;i="6000,8403,9815"; a="172216379"
X-IronPort-AV: E=Sophos;i="5.78,368,1599548400"; 
 d="gz'50?scan'50,208,50";a="172216379"
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from orsmga006.jf.intel.com ([10.7.209.51])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 25 Nov 2020 03:49:53 -0800
IronPort-SDR: vPAY2yb7Q/vaEZL1DY+2GAuBf7SBO3oJ6rQm5MQHrDNRVY/SP0ZM5fgB19U3j2mIJREFP+ozUT
 PpUsEBBAZrXQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.78,368,1599548400"; 
 d="gz'50?scan'50,208,50";a="332951220"
Received: from lkp-server01.sh.intel.com (HELO f59a693d3a73) ([10.239.97.150])
 by orsmga006.jf.intel.com with ESMTP; 25 Nov 2020 03:49:50 -0800
Received: from kbuild by f59a693d3a73 with local (Exim 4.92)
 (envelope-from <lkp@intel.com>)
 id 1khtJ0-00005R-6p; Wed, 25 Nov 2020 11:49:50 +0000
Date: Wed, 25 Nov 2020 19:49:44 +0800
From: kernel test robot <lkp@intel.com>
To: Adalbert =?utf-8?B?TGF6xINy?= <alazar@bitdefender.com>, kvm@vger.kernel.org
Subject: Re: [PATCH v10 33/81] KVM: introspection: add hook/unhook ioctls
Message-ID: <202011251942.1LdEXEwP-lkp@intel.com>
References: <20201125093600.2766-34-alazar@bitdefender.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="qMm9M+Fa2AknHoGS"
Content-Disposition: inline
In-Reply-To: <20201125093600.2766-34-alazar@bitdefender.com>
...
All warnings (new ones prefixed by >>):
   ...
   arch/x86/kvm/../../../virt/kvm/introspection/kvmi.c:90:6: warning: no previous prototype for 'kvmi_put' [-Wmissing-prototypes]
      90 | void kvmi_put(struct kvm *kvm)
         |      ^~~~~~~~
>> arch/x86/kvm/../../../virt/kvm/introspection/kvmi.c:121:5: warning: no previous prototype for 'kvmi_hook' [-Wmissing-prototypes]
     121 | int kvmi_hook(struct kvm *kvm, const struct kvm_introspection_hook *hook)
         |     ^~~~~~~~~
...
H4sICFo4vl8AAy5jb25maWcAlDzJdty2svt8RR9nkyziK8my4px3tABJsBtukqABsAdtcBS5
