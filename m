...
Received: from smtp3.osuosl.org (smtp3.osuosl.org [IPv6:2605:bc80:3010::136])
	by mail.lfdr.de (Postfix) with ESMTPS id 0DBFF54721E
	for <lists.virtualization@lfdr.de>; Sat, 11 Jun 2022 07:02:03 +0200 (CEST)
Received: from localhost (localhost [127.0.0.1])
	by smtp3.osuosl.org (Postfix) with ESMTP id 0D51260A8D;
	Sat, 11 Jun 2022 05:02:00 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
Received: from smtp3.osuosl.org ([127.0.0.1])
	by localhost (smtp3.osuosl.org [127.0.0.1]) (amavisd-new, port 10024)
	with ESMTP id k4JNOmi9P-Vl; Sat, 11 Jun 2022 05:01:57 +0000 (UTC)
Received: from lists.linuxfoundation.org (lf-lists.osuosl.org [140.211.9.56])
	by smtp3.osuosl.org (Postfix) with ESMTPS id EB9BD60D53;
	Sat, 11 Jun 2022 05:01:56 +0000 (UTC)
Received: from lf-lists.osuosl.org (localhost [127.0.0.1])
	by lists.linuxfoundation.org (Postfix) with ESMTP id 3A8B1C0081;
	Sat, 11 Jun 2022 05:01:56 +0000 (UTC)
X-Original-To: virtualization@lists.linux-foundation.org
Delivered-To: virtualization@lists.linuxfoundation.org
Received: from smtp4.osuosl.org (smtp4.osuosl.org [140.211.166.137])
 by lists.linuxfoundation.org (Postfix) with ESMTP id 7787AC002D
 for <virtualization@lists.linux-foundation.org>;
 Sat, 11 Jun 2022 05:01:54 +0000 (UTC)
Received: from localhost (localhost [127.0.0.1])
 by smtp4.osuosl.org (Postfix) with ESMTP id 7430B40990
 for <virtualization@lists.linux-foundation.org>;
 Sat, 11 Jun 2022 05:01:54 +0000 (UTC)
X-Virus-Scanned: amavisd-new at osuosl.org
...
Received: from smtp4.osuosl.org ([127.0.0.1])
 ...
 with ESMTP id HREzMPU3ZI8d
 for <virtualization@lists.linux-foundation.org>;
 Sat, 11 Jun 2022 05:01:51 +0000 (UTC)
X-Greylist: domain auto-whitelisted by SQLgrey-1.8.0
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [170.10.133.124])
 by smtp4.osuosl.org (Postfix) with ESMTPS id F2EF14098A
 for <virtualization@lists.linux-foundation.org>;
 Sat, 11 Jun 2022 05:01:50 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1654923709;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 in-reply-to:in-reply-to:references:references;
 bh=bW4zloBPZLEI7aMAlxqycY0lgjywXge297hLuQhAcSc=;
 b=fpjx+j7J93DS4GOLDHfDded/5qD5R8axb0J8MkjEls7cvvOLtEJ9pG7zxwS1AWizDtwTSV
 4TEafPUO0JgwYr7pZLLRRA9soyINWkn3ApL9T8MA+IZK6CRvqcTWX+b8I18TLxDb+sHJoO
 hXVTDK7PuodSzevVG4BX3NOvdmb5KIc=
Received: from mail-ed1-f71.google.com (mail-ed1-f71.google.com
 [209.85.208.71]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-614-AcAjGrLwPb-xqdkjyP-WSQ-1; Sat, 11 Jun 2022 01:01:48 -0400
X-MC-Unique: AcAjGrLwPb-xqdkjyP-WSQ-1
Received: by mail-ed1-f71.google.com with SMTP id
 y13-20020a056402358d00b0042dfb820070so766808edc.6
 for <virtualization@lists.linux-foundation.org>;
 Fri, 10 Jun 2022 22:01:47 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20210112;
 h=x-gm-message-state:date:from:to:cc:subject:message-id:references
 :mime-version:content-disposition:in-reply-to;
 bh=bW4zloBPZLEI7aMAlxqycY0lgjywXge297hLuQhAcSc=;
 b=
X-Gm-Message-State: AOAM530jJsXtBqLfyKeawH9rGjn+VQLdzQeA2cIl+dc050+HJW3SC9cb
 y90ZoriaYholhdgzT5p8uQ+MuK20xGm2tcRHYwaDscvtcHp/aMAl1auu/uazCzxYrytoM1GxuN8
 vqyPOzaRTk6IXQXnliUNbP4xMVLkH2TfYPQDYXu9GTg==
X-Received: by 2002:a17:906:5053:b0:70d:a0cc:b3fd with SMTP id
 e19-20020a170906505300b0070da0ccb3fdmr37524228ejk.162.1654923706445; 
 Fri, 10 Jun 2022 22:01:46 -0700 (PDT)
X-Google-Smtp-Source: ABdhPJxo/f2oLsQA/Qt5UofylxXE7eA/f2NUFZHL0KpuydtyM9gmk7bCEldPArGkMwA8iTe6vcULHw==
X-Received: by 2002:a17:906:5053:b0:70d:a0cc:b3fd with SMTP id
 e19-20020a170906505300b0070da0ccb3fdmr37524195ejk.162.1654923705818; 
 Fri, 10 Jun 2022 22:01:45 -0700 (PDT)
Received: from redhat.com ([212.116.178.142]) by smtp.gmail.com with ESMTPSA id
 sb12-20020a1709076d8c00b007025015599bsm484589ejc.214.2022.06.10.22.01.43
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Fri, 10 Jun 2022 22:01:45 -0700 (PDT)
Date: Sat, 11 Jun 2022 01:01:42 -0400
From: "Michael S. Tsirkin" <mst@redhat.com>
To: zhenwei pi <pizhenwei@bytedance.com>
Subject: Re: [PATCH v9 1/1] crypto: Introduce RSA algorithm
Message-ID: <20220611010003-mutt-send-email-mst@kernel.org>
References: <20220611033658.19645-1-pizhenwei@bytedance.com>
 <20220611033658.19645-2-pizhenwei@bytedance.com>
MIME-Version: 1.0
In-Reply-To: <20220611033658.19645-2-pizhenwei@bytedance.com>
...
I think you should combine declaration and assignment on the same line.
and then add an empty line after declarations before code.
...
> @@ -240,26 +292,89 @@ static int cryptodev_builtin_create_cipher_session(
>      return index;
>  }
>  
...
>      default:
> @@ -268,50 +383,44 @@ static int64_t cryptodev_builtin_sym_create_session(
>          return -1;
>      }
>  
> -    return session_id;
...
>                                     op_info->iv_len, errp);
> @@ -333,9 +442,99 @@ static int cryptodev_builtin_sym_operation(
...
>               CryptoDevBackend *backend,
>               Error **errp)
> @@ -348,7 +547,7 @@ static void cryptodev_builtin_cleanup(
>  
...
>      }
>  
> @@ -370,9 +569,9 @@ cryptodev_builtin_class_init(ObjectClass *oc, void *data)
>  
